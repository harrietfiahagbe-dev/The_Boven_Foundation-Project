    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'values_json', 'value' => json_encode([
                ['title' => 'Innovation', 'description' => 'We embrace creative solutions to solve educational challenges.', 'fante' => 'Adwumayɛ fofor'],
                ['title' => 'Integrity', 'description' => 'We operate with honesty and transparency in all we do.', 'fante' => 'Nokwaredi'],
                ['title' => 'Empowerment', 'description' => 'We equip young people to become problem-solvers and leaders.', 'fante' => 'Yɛre hyɛ obi den'],
